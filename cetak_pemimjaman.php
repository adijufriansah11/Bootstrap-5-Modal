...
<head>
    ...
    <title>Cetak Pemimjaman Buku</title>
...
<div style="font-size: 20px" align="center"><b>DAFTAR PEMIMJAMAN BUKU</b></div>
<table align="center">
    <tr>
        <th>No</th>
        <th>Nama Lengkap</th>
    ...
    $no = 1;
    $tampil = mysqli_query($koneksi, "SELECT * FROM tb_pinjam");

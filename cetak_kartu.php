            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><B>KARTU ANGGOTA</B></h1>
                    </div>

                <form method="POST" id="formCetak" target="_blank" action="proses_cetak.php">
                 <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <!-- Tombol "Cetak Kartu" -->
                        <button type="submit" onclick="return cetakKartu();" class="btn btn-outline-success" id="btnCetak"><i class="fa-solid fa-print mr-2"></i>Cetak Kartu Perpustakaan
                        </button>
                    </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $data['status'] ?></td>
                                        <td>
                                            <img style="width: 70px;" alt="Membership Card Template" src="img/pengguna/<?= $data['foto'] ?>">
                                                </td>
                                        <td> 
                                            <center>
                                                <input name='selector[]' type='checkbox' class='minimal flat' value="<?= $data['id_user'] ?>" onchange="updateTarget()">
                                            </center>
                                        </td>
                                     </tr>
                                    <?php }} ?>
...
<script>
    ...
    function cetakKartu() {
        ...
        if (checkboxes.length === 0) {
            ...
            updateButtonState(); // Perbarui status tombol setelah proses submit

            // Hilangkan centang dari semua kotak centang yang dipilih setelah formulir dikirim
            checkboxes.forEach(function(checkbox) {
                checkbox.checked = false;
            });

            // Perbarui status tombol setelah cetak kartu dilakukan
            updateButtonState();
        }
    }

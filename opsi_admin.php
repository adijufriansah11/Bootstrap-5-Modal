...
if (!in_array($extension_foto, array('png', 'jpg', 'jpeg'))) {
    ...
    if ($size_foto > 5000000) {
        ...
        if (move_uploaded_file($_FILES['foto']['tmp_name'], "img/admin/".$foto_baru)); {
            ...
            $simpan = mysqli_query($koneksi, "INSERT INTO tb_user (identitas, nama, username, password, level, jk, alamat, tempat_lahir, status, foto) VALUES ('$identitas', '$nama', '$username', '$password', '$level', '$jk', '$alamat', '$tempat_lahir', '$jabatan', '$foto_baru')");

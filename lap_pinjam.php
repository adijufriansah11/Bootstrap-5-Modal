            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><B>LAPORAN PEMIMJAMAN</B></h1>
                    </div>
                    ...
                    <!-- DataTales Example -->
                     <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <!-- Excel -->
                            <a href="excel_pemimjaman.php" class="btn btn-outline-success"><i class="fa fa-download mr-1"></i>
                             Export Data Excel
                            </a>
                            <!-- PDF -->
                            <a href="pdf_pemimjaman.php" class="btn btn-outline-danger" target="_blank"><i class="fa fa-download mr-1"></i>
                             Export Data PDF
                            </a>
                        </div>
                        <div class="card-body">
